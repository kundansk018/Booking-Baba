    ...
    <>
      <div className=" max-w-screen-xl mx-auto flex flex-row p-3 py-7 text-center">
        <div className="w-1/4 flex flex-col">
          <div className="flex justify-center text-[35px] text-[#546d89] mb-3">
            <FaLock />
          </div>
          <div className="p-3 flex flex-col justify-center">
            <BBTypography className=" text-[21px] text-[#0c2f54] mb-[10px] font-medium">
              100% Secure Payments
            </BBTypography>
            <BBTypography className="text-[#252b33] text-[14px] leading-7">
        ...
        <div className=" w-1/4 flex flex-col">
          <div className="flex justify-center text-[35px] text-[#546d89] font-extrabold mb-3">
            <HiOutlineSupport />
          </div>
          <div className="p-3 flex flex-col justify-center ">
            <BBTypography className=" text-[21px] text-[#0c2f54] mb-[10px] font-medium ">
