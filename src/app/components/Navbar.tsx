...
export default function Navigationbar() {
  ...
  return (
      <div style={{backgroundColor:"rgb(255, 255, 255)", boxShadow:"0 0 20px grey"}} className="flex flex-1 m-auto w-[100%] h-[54px] sticky top-0">
        <div className="container flex items-center justify-between text-blue-gray-900">
          ...
          <div style={{ position: "fixed", right: 28, top: 0 }} className="hidden lg:block">{navList}</div>
