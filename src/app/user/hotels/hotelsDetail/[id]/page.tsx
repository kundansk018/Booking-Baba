        ...
        <div className=' mx-24 '>
          <div className='flex flex-row '>
            <div className='bg-[#FFFFFF] w-[900px] mx-2  p-5 rounded-lg overflow-auto h-full container' style={{ height: innerHeight }}>
              <div className='flex flex-col border-b border-gray-300  rounded-lg'>
                ...
                <div id="About-Hotel" className='p-1 mt-1'>
                  <div className='flex justify-between'>
                    <div className=' flex text-2xl font-[24px,Poppins] text-[#0c2f54]'>
              ...
              <div id="Amenities">
                <div className='text-2xl font-[24px,Poppins] text-[#0c2f54]  mt-3'> Amenities</div>
              ...
              <div id="Choose-Room" className='bg-white'>
                <div className='text-2xl font-[24px,Poppins] text-[#0c2f54]   mt-3'> Choose Room</div>
              ...
              <div id="Reviews">
                <div className='text-2xl font-[24px,Poppins] text-[#0c2f54]  mt-3'> Reviews</div>
              ...
              <div className='bg-[#FFFFFF] w-[350px] mx-2 my-3 p-5 rounded-lg '>
                <div className='flex flex-col border-b border-gray-300  rounded-lg'>
                  <div className='border-b  border-gray-300  mx-3 my-3  '>
                    ...
                    <div className='text-2xl font-[24px,Poppins]  text-[#0c2f54]'> Room Details</div>
                  ...
                  <div className='border-b border-gray-300  mx-3 my-3 p-2 '>
                    <div className='text-2xl font-[24px,Poppins]  text-[#0c2f54]'> Address</div>
                  ...
                  <div className='   mx-3 my-3 p-2 '>
                    <div className='text-2xl font-[24px,Poppins] text-[#0c2f54]'> Quick Information</div>
                    <div >
