    ...
    <div className='bg-white mx-60 p-5'>
      ...
      <table className="table table-lg mb-0 border border-gray-300 w-full p-5">
          <thead className="card-header border-b border-gray-300 p-3 bg-gray-200">
            <tr className='h-12'>
              <td  className="border-0 w-[40%] font-semibold p-3">Description</td>
...
<div className='flex flex-row justify-between border-b border-gray-300 p-5'>
  <p>Please Note: Amount payable is inclusive of central & state goods & services Tax
...
<div className='flex flex-row justify-center border-b border-gray-300 p-5'>
  ...
  <p>Print</p>
  <p className='mt-1 h-6 w-6 ml-2'><AiFillPrinter /></p>
  </div>
