...
export default function page() {
  const { booked_hotel_res, invoice_data }: any = useSelector(
    (state: any) => state.hotel
  );
  console.log("booking dada:::::::::::::>", booked_hotel_res?.data);
  ...
  return invoice_data ? (
    <div className="bg-white mx-60 p-5">
      <div className="flex flex-row justify-between border-b border-gray-300 p-5">
        <div className="text-3xl font-bold text-[#0c2f54]">BOOKING-BABA</div>
      ...
      <div className="p-5 ">
        <table className="table table-lg mb-0 border border-gray-300 w-full p-5">
          <thead className="card-header border-b border-gray-300 p-3 bg-gray-200">
            <tr className="h-12">
              <td className="border-0 w-[40%] font-semibold p-3">
                Description
              </td>
              <td className="text-end border-0 w-[40%] font-semibold p-3">
                Rate
              </td>
              <td className="text-end border-0 w-[20%] font-semibold p-3">
                Amount
              </td>
            </tr>
          </thead>
          <tbody>
            <tr className="border-b border-gray-300 p-3 h-10">
              ...
              <td className="text-end w-[40%] ">
                ₹ 500 * {invoice_data.total_days} Night *{" "}
                {invoice_data.total_room} Rooms
              </td>
            ...
            <tr className="border-b border-gray-300  h-10">
              ...
              <td className="text-end">
                SUMMERFUN -{" "}
                <span className="text-1">20.00% One Time Discount</span>
              </td>
              <td className="text-end p-3">-$100.00</td>
            </tr>
            <tr className="border-b border-gray-300 p-3 h-10">
              <td className="bg-light-2 text-end col-span-3 font-semibold ">
                Sub Total:
              </td>
              <td className="bg-light-2 text-end col-span-3">$400.00</td>
            </tr>
            <tr className="border-b border-gray-300 p-3 h-10">
              <td className="bg-light-2 text-end  col-span-2 font-semibold">
                Tax:
              </td>
            ...
            <tr className="border-b border-gray-300 p-3 h-10">
              ...
              <td className="bg-light-2 text-end  col-span-2">
                {" "}
      ...
      <div className="flex flex-row justify-between border-b border-gray-300 p-5">
        <p>
          Please Note: Amount payable is inclusive of central & state goods &
          services Tax act applicable slab rates. Please ask Hotel for invoice
