...
export default function page() {
  const { roomData, booked_hotel_res }: any = useSelector(
      ...
      <div className="flex flex-row ">
        <div className="bg-white w-[900px] mx-3 my-3 p-5 rounded-lg h-full">
          ...
          <div className=" flex flex-row w-[100%] border-b border-gray-300 ">
            ...
            <div className="p-3">
              <p className="text-2xl text-[#0c2f54] font-medium  mt-3">
                {" "}
                {roomData?.hotelInfo?.hotelname}
              </p>
              <p className="flex mt-2">
                {" "}
                <IoLocationSharp className="mt-1 mr-1" />
                {roomData?.hotelInfo?.adress}, {roomData?.hotelInfo?.city},
                {roomData?.hotelInfo?.pin}{" "}
              </p>
              <div className="flex flex-row mt-1">
                <p className="flex flex-row">
                  {" "}
                  <FaHome className="mt-1 mr-1" /> {roomData?.selectedRoomType}
                </p>
                <p className="flex flex-row ml-3">
                  {" "}
                  <BsFillPersonFill className="mt-1 mr-1" /> 3 Guests
                </p>
              </div>
            </div>
          </div>
          ...
          <div className="my-5 border-b border-gray-300 ">
            <div className="text-xl text-[#0c2f54]  pb-3 font-medium ">
              Add Your Details
            </div>
          ...
          <div className=" mt-3">
            <div className="flex flex-row justify-between">
              ...
              <div className="flex text-xl">
                <BiRupee className="mt-1" /> <p>{roomData?.totalPrice}</p>
              </div>
            </div>
            ...
            <div className="flex flex-row justify-between mt-3">
              ...
              <div className="flex text-xl">
                {" "}
                <BiRupee className="mt-1" /> <p className="text-xl">200</p>
              </div>
            </div>
            <div className="flex flex-row justify-between  border border-gray-300 bg-gray-300 p-2 mt-5">
              ...
              <div className="flex text-xl">
                {" "}
                <BiRupee className="mt-1" /> <p className="text-xl">{price}</p>
              </div>
            </div>
