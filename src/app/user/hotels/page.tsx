      ...
      <div className=" flex flex-row bg-white mx-3">
        <div>
          {hotelData?.map((element: any, index: any) => (
            <div className=" flex flex-row bg-white mx-3">
              <div
                className="flex flex-row border border-gray-400  mt-4 p-5 rounded-lg"
                onClick={() =>
              ...
              >
                ...
                <div className="mx-5 my-3 ">
                  ...
                  {/* <div>{displayeAmenities(element?.rooms)}</div> */}
                  {/* <p className="text-cyan-500">{displayeView(element.rooms)}</p> */}

                  <p>
                    Excellent place for Families and business travellers! Great
                    Budget hotel,Rooms are neat and hygienic
                  </p>
