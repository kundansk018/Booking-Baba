...
export default function emailTemp() {
  return (
    ...
    //               Reference ID :
    //             </span>
    //             <span className="text-[#212529] font-normal text-sm">
    //               {" "}
    //               OUJICE{" "}
    //             </span>
    //           </th>
    ...
    //             Train No &amp; Name
    //           </td>
    //           <td className="text-[#212529] text-sm">4211 / Intercity Exp.</td>
    ...
    //     </li>
    //     <li className="py-1">
    //       The passenger should also carry the Electronic Reservation Slip (ERS)
    //       during the train journey failing which a penalty of $10 will be
    //       charged by the TTE/Conductor Guard.
    //     </li>
    //   </ul>
    //   <hr />
      ...
      <div className=" mx-auto p-4 bg-white">
        ...
        <div className="mb-2 ">
          <table className="w-full border-spacing-1 ">
            <tbody>
              <tr className=" text-end border border-gray-500">
                <td className="w-3/4 font-bold py-2 text-[#535b61] text-sm text-start">
                  Basic Fare :
                </td>
                <td className="w-1/4 text-end text-[#535b61]">$980.00</td>
              </tr>
