    ...
    <div className="bg-white h-full mt-5 p-5 m-auto w-[85%] justify-center rounded-lg">
      ...
      <div className="flex flex-row justify-center m-6">
        <div className="flex  flex-col mx-5 w-[300px] ">
          ...
          <BBInput containerProps={{ className: 'w-[300px]' }} type="file" label="" value={file} onChange={(e) => setFile(e.target.value)} />
        ...
        <div className="flex  flex-col mx-5 w-[300px] ">
          <BBInput containerProps={{ className: "mb-4" }} label="Price" value={price + ""} onChange={(e) => setPrice(e.target.value)} />
          <BBInput containerProps={{ className: "mb-4" }} label="Latitude & Longitude" value={location} />
          <BBInput containerProps={{ className: "mb-4" }} type="number" label="Room" value={room+ ""} onChange={(e) => setRoom(e.target.value)} />
